                            ...
                            <p><h3  class="heading">{{$question->question}}</h3></p>
                                ...
                                <div class="module-body table">
                                    <table class="table table-message">
                                        <tbody>
                                            @foreach($question->answers as $key=>$answer){{-- show all answers belong to the question --}}
                                            {{-- answers => its the method in Models\Question page. the relation method  --}}
                                            <tr class="read">
                                                
                                                <td class="cell-author hidden-phone hidden-tablet">
                                                    {{$key+1}}. {{$answer->answer}}

                                                    @if($answer->is_correct){{-- for the correct answer --}}
